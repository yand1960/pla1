...
# к каждому из серверов, спользуя эти параметров
# 3. Внутри этого цикл подать (в зависимости от типа операционной системы)
# команду и из ее теста вычлегить интерeсующий нас адрес
